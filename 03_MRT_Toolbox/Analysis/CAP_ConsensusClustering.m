...
function [Consensus_ordered] = CAP_ConsensusClustering(X,K_range,Subsample_type,Subsample_fraction,n_folds,DistType)
    ...
    for k = 1:length(K_range)
        ...
        %if it breaks, save M and Consensus here and send to Serafeim!
