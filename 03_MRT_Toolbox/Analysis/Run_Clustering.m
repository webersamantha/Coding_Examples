function [CP2,Disp,Std_Clusters,idx,d,sfrac] = Run_Clustering(XONn,n_clusters,mask,brain_info,maskP,maskN,n_rep,idx_sep_seeds,SeedType)
    ...
    [idx,CP] = kmeans(XONn_filtered',n_clusters,'distance','correlation','replicates',n_rep,'empty','drop','maxiter',300);
    %[idx,CP] = kmeans(XONn',n_clusters,'distance','correlation','replicates',n_rep,'empty','drop','maxiter',100); %Samantha changed
